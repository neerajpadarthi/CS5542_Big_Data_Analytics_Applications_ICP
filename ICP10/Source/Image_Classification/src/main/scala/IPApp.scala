...
object IPApp {
  ...
  //val IMAGE_CATEGORIES = List("crosswalk", "exit", "intersection", "parking", "pathway", "road", "sign", "signal", "speedlimit", "stop")
  ...
  def main(args: Array[String]) {
    System.setProperty("hadoop.home.dir", "C:\\softwares\\Hadoop\\hadoop")
